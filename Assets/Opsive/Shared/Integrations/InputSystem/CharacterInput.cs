// GENERATED AUTOMATICALLY FROM 'Assets/Prefabs/Input/CharacterInput 1.inputactions'
...
public class @CharacterInput1 : IInputActionCollection, IDisposable
{
    ...
    public struct GameplayActions
    {
        ...
        public GameplayActions(@CharacterInput1 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CharacterInput1 m_Wrapper;
        public UIActions(@CharacterInput1 wrapper) { m_Wrapper = wrapper; }
