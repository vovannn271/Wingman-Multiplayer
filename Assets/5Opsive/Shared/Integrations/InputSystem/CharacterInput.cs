// GENERATED AUTOMATICALLY FROM 'Assets/Prefabs/Input/CharacterInput 2.inputactions'
...
public class @CharacterInput2 : IInputActionCollection, IDisposable
{
    public InputActionAsset asset { get; }
    public @CharacterInput2()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""CharacterInput 2"",
    ""maps"": [
        {
            ""name"": ""Gameplay"",
    ...
    {
        private @CharacterInput2 m_Wrapper;
        public GameplayActions(@CharacterInput2 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CharacterInput2 m_Wrapper;
        public UIActions(@CharacterInput2 wrapper) { m_Wrapper = wrapper; }
