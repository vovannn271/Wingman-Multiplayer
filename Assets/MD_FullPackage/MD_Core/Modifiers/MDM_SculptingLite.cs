...
{
    /// <summary>
    /// MDM(Mesh Deformation Modifier): Sculpting Lite (Sculpting Pro before)
    /// Full sculpting system for mesh renderers in editor / at runtime
    /// Big thanks to community for optimizing suggestions!
    /// </summary>
    [ExecuteInEditMode]
    [RequireComponent(typeof(MeshFilter))]
    [AddComponentMenu(MD_Debug.ORGANISATION + MD_Debug.PACKAGENAME + "Sculpting Lite")]
    public class MDM_SculptingLite : MonoBehaviour
    {
