...
public class OthersMeshPaint : MonoBehaviour, IOnEventCallback
{
    //MESH DATA
    ...
    //INPUT
    //--PC
    public KeyCode MP_INPUT_PC_MeshPaintInput = KeyCode.Mouse1;
    ...
    public void PUBLIC_PaintMesh( Vector3 Position, MeshPaintModeInternal MeshPaintMode )
    {
        ...
        if (MP_ShapeType == MP_ShapeTypeInternal.Cube)
    ...
    public void SpawnPlayer( GameObject spawnedObject )
    {
        ...
        if (photonView == null)
        {
            ...
            photonView = spawnedObject.AddComponent<PhotonView>();
        }
        sapwnGO = spawnedObject;
            ...
            || PhotonNetwork.AllocateViewID( photonView ))
        {
            ...
            {
            spawnedObject.transform.position, spawnedObject.transform.rotation, photonView.ViewID
            };
    ...
    public void OnEvent( EventData photonEvent )
    {
        ...
        if (photonEvent.Code == CustomManualInstantiationEventCode)
        {
            ...
            GameObject spawnedObject = (GameObject)Instantiate( sapwnGO, (Vector3)data[0], (Quaternion)data[1] );
            PhotonView photonView = spawnedObject.GetComponent<PhotonView>();
