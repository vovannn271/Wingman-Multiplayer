...
public class SpawnManager : SpawnManagerBase
    ...
    public override void Start()
    {
        ...
        UltimateCharacterLocomotion ucl = Player.GetComponent<UltimateCharacterLocomotion>();
...
/// Manages the character instantiation within a PUN room.
/// </summary>
public abstract class SpawnManager2 : MonoBehaviourPunCallbacks, IOnEventCallback
    {
    ...
    public void SpawnPlayer( Player newPlayer )
        {
            ...
            _player = GameObject.Instantiate( GetCharacterPrefab( newPlayer ), spawnPosition, spawnRotation );
