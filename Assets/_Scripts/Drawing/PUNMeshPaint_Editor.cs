...
using MD_Plugin;
  ...
  //  [CustomEditor( typeof( PUNMeshPaint ) )]
    public class PUNMeshPaint_Editor : MD_PluginEditor.MD_EditorUtilities
{
        ...
        {
            PUNMeshPaint mp = (PUNMeshPaint)target;
            ...
            if (mp.MP_Platform == PUNMeshPaint.MP_PlatformInternal.PC)
            {
                ps( 5 );
                pv();
            ...
            else if (mp.MP_Platform == PUNMeshPaint.MP_PlatformInternal.VR)
            {
                ps( 5 );
            ...
            if (mp.MP_RotationMode == PUNMeshPaint.MP_RotationModeInternal.FollowOneAxis)
            ...
            if (mp.MP_MeshPaintType == PUNMeshPaint.MP_MeshPaintTypeInternal.DrawOnScreen)
            {
                pl( "Type: On Screen" );
                pv();
            ...
            else if (mp.MP_MeshPaintType == PUNMeshPaint.MP_MeshPaintTypeInternal.DrawOnRaycastHit)
            {
            ...
            else if (mp.MP_MeshPaintType == PUNMeshPaint.MP_MeshPaintTypeInternal.CustomDraw)
            {
                pl( "Type: Custom" );
                pv();
            ...
            if (mp.MP_FollowBrushTransform)
            {
                ...
                if (mp.MP_MeshPaintType == PUNMeshPaint.MP_MeshPaintTypeInternal.DrawOnRaycastHit)
        ...
        private void SetTo3D( bool vr = false )
        {
            ...
            if (vr)
                mp.MP_Platform = PUNMeshPaint.MP_PlatformInternal.VR;
            mp.MP_RotationMode = PUNMeshPaint.MP_RotationModeInternal.FollowSpatialAxis;
            mp.MP_MeshPaintType = vr ? PUNMeshPaint.MP_MeshPaintTypeInternal.CustomDraw : PUNMeshPaint.MP_MeshPaintTypeInternal.DrawOnRaycastHit;
