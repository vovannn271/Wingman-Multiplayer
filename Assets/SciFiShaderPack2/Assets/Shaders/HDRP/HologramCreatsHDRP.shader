...
Shader "SciFiHDRP/HologramCreats"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			PackedVaryingsMeshToPS VertexFunction(AttributesMesh inputMesh )
			{
				...
				float temp_output_19_0 = ( (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) - inputMesh.positionOS.y );
				float clampResult22 = clamp( temp_output_19_0 , 0.0 , 1.0 );
				float3 temp_output_21_0 = ( _SpawnPoint * ( 1.0 - clampResult22 ) );
				float4 transform36 = mul(GetObjectToWorldMatrix(),float4( inputMesh.positionOS , 0.0 ));
				transform36.xyz = GetAbsolutePositionWS((transform36).xyz);
				float4 lerpResult47 = lerp( float4( temp_output_21_0 , 0.0 ) , ( ( ( transform36 - float4( inputMesh.positionOS , 0.0 ) ) * _DotHighControl ) + float4( temp_output_21_0 , 0.0 ) ) , temp_output_21_0.y);
						...
						)
			{
				...
				float temp_output_19_0 = ( (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) - packedInput.ase_texcoord6.xyz.y );
				float clampResult22 = clamp( temp_output_19_0 , 0.0 , 1.0 );
				float3 temp_output_21_0 = ( _SpawnPoint * ( 1.0 - clampResult22 ) );
				float mulTime140 = _TimeParameters.x * _RaySpeed;
				float temp_output_136_0 = ( packedInput.ase_texcoord6.xyz.y + (( 3.0 * -1.0 ) + (frac( mulTime140 ) - 0.0) * (( _RayLow * -1.0 ) - ( 3.0 * -1.0 )) / (1.0 - 0.0)) );
				...
				surfaceDescription.Albedo = ( tex2D( _Albedo, uv_Albedo ) * _AlbedoColor ).rgb;
				...
				surfaceDescription.Emission = ( lerpResult126 * 1000.0 ).rgb;
				surfaceDescription.Smoothness = _Smoothness;
				surfaceDescription.Occlusion = 1;
				surfaceDescription.Alpha = clampResult58;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float temp_output_19_0 = ( (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) - packedInput.ase_texcoord1.xyz.y );
				float clampResult22 = clamp( temp_output_19_0 , 0.0 , 1.0 );
				float3 temp_output_21_0 = ( _SpawnPoint * ( 1.0 - clampResult22 ) );
				float mulTime140 = _TimeParameters.x * _RaySpeed;
				float temp_output_136_0 = ( packedInput.ase_texcoord1.xyz.y + (( 3.0 * -1.0 ) + (frac( mulTime140 ) - 0.0) * (( _RayLow * -1.0 ) - ( 3.0 * -1.0 )) / (1.0 - 0.0)) );
				float clampResult147 = clamp( ( 1.0 - ( abs( temp_output_136_0 ) * _RayWidth ) ) , 0.2 , 1.0 );
				float clampResult285 = clamp( ( 1.0 - ( abs( temp_output_136_0 ) * 0.04 ) ) , 0.1 , 1.0 );
				float temp_output_320_0 = ( temp_output_19_0 + _LineHight );
				float clampResult323 = clamp( temp_output_320_0 , 0.0 , 1.0 );
		...
		Pass
		{
					...
					)
			{
				...
				float temp_output_19_0 = ( (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) - packedInput.ase_texcoord4.xyz.y );
				float clampResult22 = clamp( temp_output_19_0 , 0.0 , 1.0 );
				float3 temp_output_21_0 = ( _SpawnPoint * ( 1.0 - clampResult22 ) );
				float clampResult53 = clamp( temp_output_21_0.y , 0.0 , 1.0 );
				float clampResult58 = clamp( ( ( 1.0 - clampResult53 ) + _Opacity ) , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float temp_output_19_0 = ( (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0)) - packedInput.ase_texcoord8.xyz.y );
				float clampResult22 = clamp( temp_output_19_0 , 0.0 , 1.0 );
				float3 temp_output_21_0 = ( _SpawnPoint * ( 1.0 - clampResult22 ) );
				float mulTime140 = _TimeParameters.x * _RaySpeed;
				float temp_output_136_0 = ( packedInput.ase_texcoord8.xyz.y + (( 3.0 * -1.0 ) + (frac( mulTime140 ) - 0.0) * (( _RayLow * -1.0 ) - ( 3.0 * -1.0 )) / (1.0 - 0.0)) );
				float clampResult147 = clamp( ( 1.0 - ( abs( temp_output_136_0 ) * _RayWidth ) ) , 0.2 , 1.0 );
				float clampResult285 = clamp( ( 1.0 - ( abs( temp_output_136_0 ) * 0.04 ) ) , 0.1 , 1.0 );
				float temp_output_320_0 = ( temp_output_19_0 + _LineHight );
				float clampResult323 = clamp( temp_output_320_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
579;330;1296;598;-1092.741;192.2888;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;20;-661.3577,464.0225;Float;False;Global;_ShaderDisplacement;_ShaderDisplacement;17;0;Create;True;0;0;False;0;False;0;0.6388893;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;67;171.1317,287.4914;Inherit;False;Property;_SpawnPoint;SpawnPoint;9;0;Create;True;0;0;False;0;False;0,0,0;10.04,26.66,1;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;129;1116.823,239.9285;Inherit;False;Constant;_Const5;Const5;12;0;Create;True;0;0;False;0;False;155;185.82;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;40;516.3109,781.7116;Inherit;False;Property;_DotHighControl;DotHighControl;10;0;Create;True;0;0;False;0;False;0.02;0.07;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.PowerNode;128;1325.732,86.23958;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;327;1491.792,40.66111;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;3;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;1371.195,560.9498;Inherit;False;Property;_Opacity;Opacity;11;0;Create;True;0;0;False;0;False;0;0.501;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;127;1328.598,226.7502;Inherit;False;Property;_LineColor;LineColor;16;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;10.06944,14.28455,44.72704,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;126;1714.712,-9.53988;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;341;1845.741,72.71124;Inherit;False;Constant;_Float0;Float 0;19;0;Create;True;0;0;False;0;False;1000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;122;1650.31,222.921;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;False;0;False;0;0.457;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;340;1985.741,59.71124;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;296;1643.885,-216.7133;Inherit;True;Property;_Normal;Normal;2;0;Create;True;0;0;False;0;False;-1;f8b6b2d6cf795c84f9f02d42d2720e06;f8b6b2d6cf795c84f9f02d42d2720e06;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.WireNode;339;2006.379,618.4232;Inherit;False;1;0;FLOAT4;0,0,0,0;False;1;FLOAT4;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;1652.31,139.921;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;False;0;False;0;0.481;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;338;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;331;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;330;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;329;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;334;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;337;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;336;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;335;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;333;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;328;2247.665,83.09139;Half;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;SciFiHDRP/HologramCreats;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;332;2247.665,83.09139;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
...
WireConnection;340;0;126;0
WireConnection;340;1;341;0
WireConnection;296;5;303;0
WireConnection;339;0;47;0
WireConnection;58;0;57;0
WireConnection;30;0;28;0
WireConnection;30;1;31;0
WireConnection;328;0;30;0
WireConnection;328;1;296;0
WireConnection;328;4;120;0
WireConnection;328;6;340;0
WireConnection;328;7;122;0
WireConnection;328;9;58;0
WireConnection;328;11;339;0
ASEEND*/
//CHKSM=EF2837FE45AFBA99FD322F8F5D99721438097C33