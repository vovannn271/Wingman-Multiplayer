...
Shader "SciFiHDRP/Sci-FiRefraction"
{
	Properties
	{
		...
		[ASEEnd]_Refraction("Refraction", Float) = 0.9
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float vpY32 = packedInput.ase_texcoord6.xyz.y;
				...
				float2 texCoord87 = packedInput.ase_texcoord5.xy * temp_cast_1 + float2( 0,0 );
				float2 panner89 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord87);
				...
				float2 texCoord182 = packedInput.ase_texcoord5.xy * temp_cast_2 + float2( 0,0 );
				float2 panner184 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord182);
				...
				float2 texCoord179 = packedInput.ase_texcoord5.xy * temp_cast_3 + float2( 0,0 );
				float2 panner183 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord179);
				...
				float4 lerpResult220 = lerp( lerpResult170 , ( tex2DNode218 * _EmissionColor1 ) , grayscale221);
				...
				float clampResult233 = clamp( ( ( tex2DNode126.a * lerpResult201 ) + smoothstepResult46 + -1.2 ) , 0.0 , 1.0 );
				float temp_output_239_0 = ( 1.0 - clampResult233 );
				float lerpResult256 = lerp( 0.9 , _Smoothness , temp_output_239_0);
				
				float2 uv_AO = packedInput.ase_texcoord5.xy * _AO_ST.xy + _AO_ST.zw;
				
				surfaceDescription.Albedo = lerpResult136.rgb;
				...
				surfaceDescription.Emission = ( 5000.0 * lerpResult220 ).rgb;
				surfaceDescription.Smoothness = lerpResult256;
				surfaceDescription.Occlusion = tex2D( _AO, uv_AO ).r;
				surfaceDescription.Alpha = temp_output_239_0;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float4 tex2DNode126 = tex2D( _Albedo, uv_Albedo );
				float vpY32 = packedInput.ase_texcoord1.xyz.y;
				float temp_output_54_0 = (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0));
				float temp_output_71_0 = ( -1.0 * temp_output_54_0 );
				float temp_output_76_0 = ( vpY32 + temp_output_71_0 + 0.4 );
				float clampResult139 = clamp( pow( ( temp_output_76_0 * -1.0 * _DarkAreaScale ) , _DarkAreaPower ) , 0.0 , 1.0 );
				...
				float2 temp_cast_1 = (_DissolveTiling).xx;
				float2 texCoord87 = packedInput.ase_texcoord.xy * temp_cast_1 + float2( 0,0 );
				float2 panner89 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord87);
				float temp_output_82_0 = ( 1.0 - tex2D( _Noises, panner89 ).r );
				float temp_output_2_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult13 = clamp( step( temp_output_82_0 , ( temp_output_2_0 + 0.1 ) ) , 0.0 , 1.0 );
				...
				float4 lerpResult91 = lerp( ( _DissolveColor * ( 1.0 - step( temp_output_82_0 , ( temp_output_2_0 + _DissolveColorPower ) ) ) ) , float4( 0,0,0,0 ) , lerpResult101);
				float2 temp_cast_2 = (_FirstTextureTiling).xx;
				float2 texCoord182 = packedInput.ase_texcoord.xy * temp_cast_2 + float2( 0,0 );
				float2 panner184 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord182);
				float4 tex2DNode75 = tex2D( _Noises, panner184 );
				float clampResult86 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult27 = lerp( tex2DNode75.g , 0.0 , clampResult86);
				float4 lerpResult131 = lerp( lerpResult91 , _FirstTextureColor , lerpResult27);
				float2 temp_cast_3 = (_SecondTextureTiling).xx;
				float2 texCoord179 = packedInput.ase_texcoord.xy * temp_cast_3 + float2( 0,0 );
				float2 panner183 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord179);
				float4 tex2DNode167 = tex2D( _Noises, panner183 );
				float clampResult166 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult168 = lerp( tex2DNode167.b , 0.0 , clampResult166);
		...
		Pass
		{
					...
					)
			{
				...
				float2 texCoord87 = packedInput.ase_texcoord1.xy * temp_cast_0 + float2( 0,0 );
				float2 panner89 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord87);
				float temp_output_82_0 = ( 1.0 - tex2D( _Noises, panner89 ).r );
				float temp_output_2_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult13 = clamp( step( temp_output_82_0 , ( temp_output_2_0 + 0.1 ) ) , 0.0 , 1.0 );
				float vpY32 = packedInput.ase_texcoord2.xyz.y;
				float temp_output_54_0 = (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0));
				float temp_output_71_0 = ( -1.0 * temp_output_54_0 );
				float temp_output_76_0 = ( vpY32 + temp_output_71_0 + 0.4 );
				float clampResult85 = clamp( pow( ( temp_output_76_0 * -1.0 * _DissolveSquareScale ) , _DissolveSquarePower ) , 0.0 , 1.0 );
				...
				float2 texCoord182 = packedInput.ase_texcoord1.xy * temp_cast_1 + float2( 0,0 );
				float2 panner184 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord182);
				float4 tex2DNode75 = tex2D( _Noises, panner184 );
				float clampResult86 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult199 = lerp( tex2DNode75.g , 1.0 , clampResult86);
				float2 temp_cast_2 = (_SecondTextureTiling).xx;
				float2 texCoord179 = packedInput.ase_texcoord1.xy * temp_cast_2 + float2( 0,0 );
				float2 panner183 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord179);
				float4 tex2DNode167 = tex2D( _Noises, panner183 );
				float clampResult166 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult200 = lerp( tex2DNode167.b , 1.0 , clampResult166);
		...
		Pass
		{
					...
					)
			{
				...
				float4 tex2DNode126 = tex2D( _Albedo, uv_Albedo );
				float2 temp_cast_0 = (_DissolveTiling).xx;
				float2 texCoord87 = packedInput.ase_texcoord3.xy * temp_cast_0 + float2( 0,0 );
				float2 panner89 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord87);
				float temp_output_82_0 = ( 1.0 - tex2D( _Noises, panner89 ).r );
				float temp_output_2_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult13 = clamp( step( temp_output_82_0 , ( temp_output_2_0 + 0.1 ) ) , 0.0 , 1.0 );
				float vpY32 = packedInput.ase_texcoord4.xyz.y;
				float temp_output_54_0 = (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0));
				float temp_output_71_0 = ( -1.0 * temp_output_54_0 );
				float temp_output_76_0 = ( vpY32 + temp_output_71_0 + 0.4 );
				float clampResult85 = clamp( pow( ( temp_output_76_0 * -1.0 * _DissolveSquareScale ) , _DissolveSquarePower ) , 0.0 , 1.0 );
				float lerpResult79 = lerp( clampResult13 , 1.0 , clampResult85);
				float2 temp_cast_1 = (_FirstTextureTiling).xx;
				float2 texCoord182 = packedInput.ase_texcoord3.xy * temp_cast_1 + float2( 0,0 );
				float2 panner184 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord182);
				float4 tex2DNode75 = tex2D( _Noises, panner184 );
				float clampResult86 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult199 = lerp( tex2DNode75.g , 1.0 , clampResult86);
				float2 temp_cast_2 = (_SecondTextureTiling).xx;
				float2 texCoord179 = packedInput.ase_texcoord3.xy * temp_cast_2 + float2( 0,0 );
				float2 panner183 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord179);
				float4 tex2DNode167 = tex2D( _Noises, panner183 );
				float clampResult166 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult200 = lerp( tex2DNode167.b , 1.0 , clampResult166);
		...
		Pass
		{
						...
						)
			{
				...
				float4 tex2DNode126 = tex2D( _Albedo, uv_Albedo );
				float vpY32 = packedInput.ase_texcoord8.xyz.y;
				float temp_output_54_0 = (_ObjectLow + (_ShaderDisplacement - 0.0) * (_ObjectHigh - _ObjectLow) / (1.0 - 0.0));
				float temp_output_71_0 = ( -1.0 * temp_output_54_0 );
				float temp_output_76_0 = ( vpY32 + temp_output_71_0 + 0.4 );
				float clampResult139 = clamp( pow( ( temp_output_76_0 * -1.0 * _DarkAreaScale ) , _DarkAreaPower ) , 0.0 , 1.0 );
				...
				float2 temp_cast_1 = (_DissolveTiling).xx;
				float2 texCoord87 = packedInput.ase_texcoord7.xy * temp_cast_1 + float2( 0,0 );
				float2 panner89 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord87);
				float temp_output_82_0 = ( 1.0 - tex2D( _Noises, panner89 ).r );
				float temp_output_2_0 = (1.0 + (_DissolvePower - 0.0) * (-0.1 - 1.0) / (1.0 - 0.0));
				float clampResult13 = clamp( step( temp_output_82_0 , ( temp_output_2_0 + 0.1 ) ) , 0.0 , 1.0 );
				...
				float4 lerpResult91 = lerp( ( _DissolveColor * ( 1.0 - step( temp_output_82_0 , ( temp_output_2_0 + _DissolveColorPower ) ) ) ) , float4( 0,0,0,0 ) , lerpResult101);
				float2 temp_cast_2 = (_FirstTextureTiling).xx;
				float2 texCoord182 = packedInput.ase_texcoord7.xy * temp_cast_2 + float2( 0,0 );
				float2 panner184 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord182);
				float4 tex2DNode75 = tex2D( _Noises, panner184 );
				float clampResult86 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _FirstTextureHight ) * -1.0 * _FirstTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult27 = lerp( tex2DNode75.g , 0.0 , clampResult86);
				float4 lerpResult131 = lerp( lerpResult91 , _FirstTextureColor , lerpResult27);
				float2 temp_cast_3 = (_SecondTextureTiling).xx;
				float2 texCoord179 = packedInput.ase_texcoord7.xy * temp_cast_3 + float2( 0,0 );
				float2 panner183 = ( 1.0 * _Time.y * float2( 0,-0.5 ) + texCoord179);
				float4 tex2DNode167 = tex2D( _Noises, panner183 );
				float clampResult166 = clamp( abs( ( ( vpY32 + temp_output_71_0 + _SecondTextureHight ) * -1.0 * _SecondTextureScale ) ) , 0.0 , 1.0 );
				float lerpResult168 = lerp( tex2DNode167.b , 0.0 , clampResult166);
...
/*ASEBEGIN
Version=18500
113;749;1296;598;1.648102;1040.313;1;True;False
Node;AmplifyShaderEditor.RangedFloatNode;53;-3064.572,189.4937;Float;False;Property;_ObjectLow;ObjectLow;9;0;Create;True;0;0;False;0;False;0;-7;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;90;-3114.039,-2342.804;Float;False;Property;_DissolveTiling;DissolveTiling;11;0;Create;True;0;0;False;0;False;1;18.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;57;-3179.321,106.7301;Float;False;Global;_ShaderDisplacement;_ShaderDisplacement;8;0;Create;True;0;0;False;0;False;0;-0.2143638;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;52;-3065.768,271.6888;Float;False;Property;_ObjectHigh;ObjectHigh;8;0;Create;True;0;0;False;0;False;0;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1;-2792.722,-2101.98;Float;False;Property;_DissolvePower;DissolvePower;13;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-2352.462,-2387.743;Inherit;True;Property;_Noises;Noises;10;0;Create;True;0;0;False;0;False;-1;None;d13ca39b41162ec409f248ce502bd9dc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;160;-1962.382,-343.8934;Float;False;Property;_SecondTextureHight;SecondTextureHight;22;0;Create;True;0;0;False;0;False;0;-4;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;3;-2285.197,-2187.716;Float;False;Property;_DissolveColorPower;DissolveColorPower;14;0;Create;True;0;0;False;0;False;0.02;-0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;9;-1963.244,-2048.934;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;73;-1980.877,-874.433;Float;False;Property;_FirstTextureHight;FirstTextureHight;18;0;Create;True;0;0;False;0;False;0;-0.97;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-2007.609,-1342.877;Float;False;Property;_DissolveSquareScale;DissolveSquareScale;15;0;Create;True;0;0;False;0;False;0;0.651;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-1699.766,-830.1476;Float;False;Property;_FirstTextureScale;FirstTextureScale;19;0;Create;True;0;0;False;0;False;0;0.54;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;162;-1690.271,-302.6078;Float;False;Property;_SecondTextureScale;SecondTextureScale;23;0;Create;True;0;0;False;0;False;0;0.35;0.1;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;107;-1702.104,-1343.205;Float;False;Property;_DissolveSquarePower;DissolveSquarePower;16;0;Create;True;0;0;False;0;False;1;0.84;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-1905.148,-694.7529;Float;False;Property;_SecondTextureTiling;SecondTextureTiling;24;0;Create;True;0;0;False;0;False;0;24.33;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;181;-1768.607,-1198.311;Float;False;Property;_FirstTextureTiling;FirstTextureTiling;20;0;Create;True;0;0;False;0;False;0;14.13;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;8;-1575.142,-2422.35;Float;False;Property;_DissolveColor;DissolveColor;12;1;[HDR];Create;True;0;0;False;0;False;0.180188,4.594794,0,0;0.1333333,0.1764706,0.7490196,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;208;-1655.069,-91.7218;Float;False;Property;_OpacityScale;OpacityScale;27;0;Create;True;0;0;False;0;False;0;0.14;0.01;0.9;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;204;-1337.839,-78.9095;Float;False;Property;_OpacityPower;OpacityPower;28;0;Create;True;0;0;False;0;False;1;1;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;167;-1100.969,-736.4238;Inherit;True;Property;_SecondTexture;SecondTexture;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;5;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;75;-1000.334,-1240.665;Inherit;True;Property;_FirstTexture;FirstTexture;10;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;5;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;132;-363.2149,-1396.56;Float;False;Property;_FirstTextureColor;FirstTextureColor;17;1;[HDR];Create;True;0;0;False;0;False;0,0.07736176,0.8773585,0;0.5176471,0.7058824,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;171;-181.4835,-1197.442;Float;False;Property;_SecondTextureColor;SecondTextureColor;21;1;[HDR];Create;True;0;0;False;0;False;0,0.07736176,0.8773585,0;0.5176471,0.7058824,2.996078,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;218;-28.16073,-1597.008;Inherit;True;Property;_Emission;Emission;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;126;-882.5004,-2435.056;Inherit;True;Property;_Albedo;Albedo;0;0;Create;True;0;0;False;0;False;-1;None;b5175e5b6e2e0584cbcdc0947aa4c63a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;228;588.9897,-730.097;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;140;-1855.454,-1770.352;Float;False;Property;_DarkAreaScale;DarkAreaScale;25;0;Create;True;0;0;False;0;False;0;0.34;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;255;587.4121,-553.042;Inherit;False;Constant;_Float1;Float 1;34;0;Create;True;0;0;False;0;False;-1.2;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;232;762.942,-729.123;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;224;137.7501,-1782.019;Inherit;False;Property;_EmissionColor1;EmissionColor1;7;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;141;-1597.59,-1661.058;Float;False;Property;_DarkAreaPower;DarkAreaPower;26;0;Create;True;0;0;False;0;False;1;3.24;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ClampOpNode;233;926.9727,-730.3496;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;125;-841.5622,-2245.002;Float;False;Property;_AlbedoColor;AlbedoColor;1;0;Create;True;0;0;False;0;False;0,0,0,0;1,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;212;529.2113,-1006.966;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;False;0;False;0;0.516;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;214;-306.9906,-1999.957;Inherit;False;Property;_NormalPower;NormalPower;29;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;220;838.9318,-1160.283;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;239;1103.571,-731.8083;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;254;827.3156,-1271.138;Inherit;False;Constant;_Float0;Float 0;31;0;Create;True;0;0;False;0;False;5000;5000;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;175;-91.24333,-2005.258;Inherit;True;Property;_Normal;Normal;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;176;515.8842,-928.8592;Inherit;True;Property;_AO;AO;5;0;Create;True;0;0;False;0;False;-1;None;943045dd137dc9b46a6d1ac8cb9e0cf8;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;235;980.8153,-832.7186;Inherit;False;Property;_Refraction;Refraction;30;0;Create;True;0;0;False;0;False;0.9;1.01;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;256;913.2935,-1003.844;Inherit;False;3;0;FLOAT;0.9;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;211;524.2527,-1090.702;Inherit;False;Property;_Metallic;Metallic;2;0;Create;True;0;0;False;0;False;0;0.511;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;253;1039.316,-1085.137;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;246;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;248;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;240;1340.232,-1109.415;Half;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;SciFiHDRP/Sci-FiRefraction;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;1;  Rendering Pass;1;  Refraction Model;2;    Blending Mode;2;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;0;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;249;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;243;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;250;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;247;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;245;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;241;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;244;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;242;1166.589,-1121.183;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
...
WireConnection;256;2;239;0
WireConnection;253;0;254;0
WireConnection;253;1;220;0
WireConnection;240;0;136;0
WireConnection;240;1;175;0
WireConnection;240;4;211;0
WireConnection;240;6;253;0
WireConnection;240;7;256;0
WireConnection;240;8;176;1
WireConnection;240;9;239;0
WireConnection;240;17;235;0
ASEEND*/
//CHKSM=515AC736ADA2E1FC98F1A4791A48B728E5509CD0