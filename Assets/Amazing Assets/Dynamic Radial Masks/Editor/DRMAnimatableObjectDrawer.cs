    ...
    namespace DynamicRadialMasks
    {
        ...
        public class DRMAnimatableObjectDrawer : PropertyDrawer
        {
            ...
            void DrawValue(SerializedProperty property, string propName, Rect position, string label, bool miniLabel, bool checkForZero)
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.GUIBackgroundColor(errorColor))
                {
            ...
            void DrawMinMax(SerializedProperty property, string propName, Rect position, string label, bool miniLabel, bool checkForZero)
            {
                ...
                using (new AmazingAssets.EditorGUIUtility.EditorGUIUtilityLabelWidth(EditorStyles.label.CalcSize(new GUIContent("Mim")).x))     //yes, 'Mim' and not 'Min'. 'm' gives just a little bit more space than 'n'
                {
                ...
                using (new AmazingAssets.EditorGUIUtility.EditorGUIUtilityLabelWidth(EditorStyles.label.CalcSize(new GUIContent(" Max")).x))
                {
