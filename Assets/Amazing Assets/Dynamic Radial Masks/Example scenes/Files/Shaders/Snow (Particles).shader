Shader "Amazing Assets/Dynamic Radial Masks/Example/Additive (Soft)" 
{
	Properties 
	{
		...
		SubShader 
		{
			Pass 
			{
				...
				fixed4 frag (v2f i) : SV_Target
				{
					...
					float mask = DynamicRadialMasks_HeightField_4_Advanced_Normalized_ID1_Global(i.worldPos, 0);
					col.a *= mask;
					...
					float emissionMask = DynamicRadialMasks_Torus_4_Advanced_Additive_ID1_Global(i.worldPos, 0);
					col.rgb += (_SonarEmission.rgb * mask ) * emissionMask;
