...
namespace HeathenEngineering.SteamworksIntegration
{
    ...
    {
        [Serializable]
        public class ResultsEvent : UnityEvent<List<UGCCommunityItem>> { }
        ...
        public void SearchAll(string filter)
        {
            ...
            activeQuery = UgcQuery.Create(EUGCQuery.k_EUGCQuery_RankedByTrend, EUGCMatchingUGCType.k_EUGCMatchingUGCType_Items_ReadyToUse, creatorAppId, SteamSettings.current.applicationId);
        ...
        {
            lastSearchString = filter;
            activeQuery = UgcQuery.Create(SteamUser.GetSteamID().GetAccountID(), EUserUGCList.k_EUserUGCList_Favorited, EUGCMatchingUGCType.k_EUGCMatchingUGCType_Items_ReadyToUse, EUserUGCListSortOrder.k_EUserUGCListSortOrder_TitleAsc, creatorAppId, SteamSettings.current.applicationId);
            if (!string.IsNullOrEmpty(filter))
            {
                API.UserGeneratedContent.Client.SetSearchText(activeQuery.handle, filter);
            }
        ...
        {
            lastSearchString = filter;
            activeQuery = UgcQuery.Create(SteamUser.GetSteamID().GetAccountID(), EUserUGCList.k_EUserUGCList_Followed, EUGCMatchingUGCType.k_EUGCMatchingUGCType_Items_ReadyToUse, EUserUGCListSortOrder.k_EUserUGCListSortOrder_TitleAsc, creatorAppId, SteamSettings.current.applicationId);
            if (!string.IsNullOrEmpty(filter))
            {
                API.UserGeneratedContent.Client.SetSearchText(activeQuery.handle, filter);
            }
