...
namespace HeathenEngineering.SteamworksIntegration.API
{
    ...
    public static class Matchmaking
    {
        public static class Client
        {
            ...
            /// </summary>
            public static List<Lobby> memberOfLobbies = new List<Lobby>();
                    ...
                    if (m_LobbyDataUpdate_t == null)
                        m_LobbyDataUpdate_t = Callback<LobbyDataUpdate_t>.Create((responce) =>
                        {
                            if(responce.m_ulSteamIDLobby == responce.m_ulSteamIDMember)
                            {
                                ...
                                var lobby = new Lobby { id = new CSteamID(responce.m_ulSteamIDLobby) };
                                if (lobby[Lobby.DataKick].Contains("[" + User.Client.Id.ToString() + "]"))
            ...
            public static void CreateLobby(ELobbyType type, int maxMembers, Action<Lobby, bool> callback)
            {
                ...
                m_LobbyCreated_t.Set(handle, (r, e) =>
                {
                    ...
                    {
                        SetLobbyData(new CSteamID(r.m_ulSteamIDLobby), Lobby.DataType, ((int)type).ToString());
                        memberOfLobbies.Add(new CSteamID(r.m_ulSteamIDLobby));
                    }

                    callback.Invoke(new CSteamID(r.m_ulSteamIDLobby), e);
                });
            }
            /// <summary>
            ...
            /// <returns></returns>
            public static bool DeleteLobbyData(Lobby lobby, string key) => SteamMatchmaking.DeleteLobbyData(lobby, key);
            /// <summary>
            ...
            /// <returns></returns>
            public static string GetLobbyData(Lobby lobby, string key) => SteamMatchmaking.GetLobbyData(lobby, key);
            /// <summary>
            ...
            public static LobbyMember[] GetLobbyMembers(Lobby lobby)
            {
                ...
                var results = new LobbyMember[count];
                for (int i = 0; i < count; i++)
                {
                    results[i] = new LobbyMember
                    {
                        lobby = lobby,
            ...
            /// <param name="lobby"></param>
            /// <returns></returns>
            public static int GetLobbyMemberLimit(Lobby lobby) => SteamMatchmaking.GetLobbyMemberLimit(lobby);
            /// <summary>
            ...
            /// <param name="lobby"></param>
            /// <returns></returns>
            public static CSteamID GetLobbyOwner(Lobby lobby) => SteamMatchmaking.GetLobbyOwner(lobby);
            /// <summary>
            ...
            /// <returns></returns>
            public static bool InviteUserToLobby(Lobby lobby, UserData user) => SteamMatchmaking.InviteUserToLobby(lobby, user);
            /// <summary>
            ...
            public static void LeaveLobby(Lobby lobby)
            {
                ...
                memberOfLobbies.RemoveAll(p => p.id == lobby);
            }
            /// <summary>
            ...
            /// <returns></returns>
            public static bool RequestLobbyData(Lobby lobby) => SteamMatchmaking.RequestLobbyData(lobby);
            /// <summary>
            ...
            public static void RequestLobbyList(Action<Lobby[], bool> callback)
            {
                ...
                m_LobbyMatchList_t.Set(handle, (results, error) =>
                {
                    ...
                    {
                        var buffer = new Lobby[results.m_nLobbiesMatching];
                    ...
                    {
                        callback.Invoke(new Lobby[0], error);
                    }
                });
            }
            /// <summary>
            ...
            /// <returns></returns>
            public static bool SendLobbyChatMsg(Lobby lobby, byte[] messageBody) => SteamMatchmaking.SendLobbyChatMsg(lobby, messageBody, messageBody.Length);
            /// <summary>
            ...
            /// <returns></returns>
            public static bool SetLobbyData(Lobby lobby, string key, string value) => SteamMatchmaking.SetLobbyData(lobby, key, value);
            /// <summary>
            ...
            public static void SetLobbyGameServer(Lobby lobby, uint ip, ushort port, CSteamID gameServerId) => SteamMatchmaking.SetLobbyGameServer(lobby, ip, port, gameServerId);
            /// <summary>
            /// Sets the game server associated with the lobby.
            /// </summary>
            /// <remarks>
            ...
            /// <param name="port">Sets the connection port of the game server, in host order.</param>
            /// <param name="gameServerId">Sets the Steam ID of the game server. Use k_steamIDNil if you're not setting this.</param>
            public static void SetLobbyGameServer(Lobby lobby, string ip, ushort port, CSteamID gameServerId) => SteamMatchmaking.SetLobbyGameServer(lobby, Utilities.IPStringToUint(ip), port, gameServerId);
            /// <summary>
            ...
            /// <returns></returns>
            public static bool SetLobbyJoinable(Lobby lobby, bool joinable) => SteamMatchmaking.SetLobbyJoinable(lobby, joinable);
            /// <summary>
            ...
            /// <returns></returns>
            public static string GetLobbyMemberData(Lobby lobby, CSteamID member, string key) => SteamMatchmaking.GetLobbyMemberData(lobby, member, key);
            /// <summary>
            ...
            public static bool GetMember(Lobby lobby, CSteamID id, out LobbyMember member)
            {
                ...
                {
                    member = new LobbyMember { lobby = lobby, user = id };
                    return true;
                }
            }
            /// <summary>
            ...
            public static void SetLobbyMemberData(Lobby lobby, string key, string value) => SteamMatchmaking.SetLobbyMemberData(lobby, key, value);
            /// <summary>
            ...
            /// <returns></returns>
            public static bool SetLobbyMemberLimit(Lobby lobby, int maxMembers) => SteamMatchmaking.SetLobbyMemberLimit(lobby, maxMembers);
            /// <summary>
            ...
            /// <returns></returns>
            public static bool SetLobbyOwner(Lobby lobby, CSteamID newOwner) => SteamMatchmaking.SetLobbyOwner(lobby, newOwner);
            /// <summary>
            ...
            {
                SteamMatchmaking.SetLobbyData(lobby, Lobby.DataType, ((int)type).ToString());
