...
namespace HeathenEngineering.SteamworksIntegration.API
{
    ...
    public static class Clans
    {
        public static class Client
        {
            ...
            public static void JoinChatRoom(Clan clan, Action<ChatRoom, bool> callback)
            {
                if (callback == null)
                    return;
            ...
            /// <returns></returns>
            public static CSteamID GetChatMemberByIndex(CSteamID clan, int index) => SteamFriends.GetChatMemberByIndex(clan, index);
            /// <summary>
            ...
            /// <returns></returns>
            public static Clan GetClanByIndex(int clanIndex) => SteamFriends.GetClanByIndex(clanIndex);
            /// <summary>
            ...
            /// <returns></returns>
            public static int GetChatMemberCount(CSteamID clanId) => SteamFriends.GetClanChatMemberCount(clanId);
            /// <summary>
            ...
            /// <returns></returns>
            public static string GetName(Clan clanId) => SteamFriends.GetClanName(clanId);
            /// <summary>
            ...
            /// <returns></returns>
            public static UserData GetOfficerByIndex(Clan clanId, int officerIndex) => SteamFriends.GetClanOfficerByIndex(clanId, officerIndex);
            /// <summary>
            ...
            /// <returns></returns>
            public static int GetOfficerCount(Clan clanId) => SteamFriends.GetClanOfficerCount(clanId);
            /// <summary>
            ...
            /// <param name="clanId"></param>
            /// <returns></returns>
            public static CSteamID GetOwner(Clan clanId) => SteamFriends.GetClanOwner(clanId);
            /// <summary>
            ...
            /// <returns></returns>
            public static string GetTag(Clan clanId) => SteamFriends.GetClanTag(clanId);
            /// <summary>
            ...
            /// <param name="clanId"></param>
            /// <returns></returns>
            public static bool IsClanPublic(Clan clanId) => SteamFriends.IsClanPublic(clanId);
            /// <summary>
            /// Checks if the Steam group is an official game group/community hub.
            /// </summary>
            /// <param name="clanId"></param>
            /// <returns></returns>
            public static bool IsClanOfficialGameGroup(CSteamID clanId) => SteamFriends.IsClanOfficialGameGroup(clanId);
            /// <summary>
